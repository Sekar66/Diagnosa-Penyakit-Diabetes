		...
		switch ($jawaban){
			case 'benar':
				...
				while ($record = mysqli_fetch_array($query)){
					...
					$tipe_satu = $record['tipe_satu'];
					$tipe_dua = $record['tipe_dua'];
					$gestasional = $record['gestasional'];
					...
					$_SESSION['n_atas1'] *= $tipe_satu;
					$_SESSION['n_atas2'] *= $tipe_dua;
					$_SESSION['n_atas3'] *= $gestasional;

	...
	if (isset($_GET['solusi'])){
		...
		*/
		...
		if ($prob_sakit1 == 30 && $prob_sakit2 == 30 && $prob_sakit3 == 40){
			...
			$prob_sakit2 *= 0;
			$prob_sakit3 *= 0;
			$sakit = "Anda Tidak Mengidap Penyakit Diabetes Melitus";
		}
		...
		echo "<th>Diabetes Melitus Tipe 1</th>";
		echo "<th>Diabetes Melitus Tipe 2</th>";
		echo "<th>Diabetes Melitus Tipe Gestasional</th>";
		echo "<th>Tidak Diabetes Melitus</th>";
		echo "</thead>";
		echo "<tbody>";
		echo "<tr>";
		...
		echo"<br><b><h4>SOLUSI PENYAKIT :</br></b></h4>";
		while ($record = mysqli_fetch_array($query)){
			...
			echo"<a href=\"periksa.php\" class=\"read_more2\">Periksa Ulang</a> ";
			echo"</div>";
			echo"</div>";
		echo "</div>";
	}
		...
		*/
		...
		echo"<div >";
		echo "<p>Disini, anda dapat melakukan diagnosa mandiri untuk mengetahui apakah anda mengidap penyakit diabetes melitus atau tidak. Anda hanya perlu menjawab setiap pertanyaan berkaitan dengan kondisi / keluhan yang anda rasakan saat ini. Kemudian sistem akan melakukan prediksi berdasarkan jawaban anda.</p>";
